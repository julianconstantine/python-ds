...
# FILE: COLLECTIONS.PY
# PURPOSE: Play around with Python's built-in collection data types:
#   1) Lists (Sequential, Mutable)
#   2) Strings (Sequential, Immutable)
#   3) Tuples (Sequential, Immutable)
#   4) Sets (Non-Sequential)
#   5) Dictionaries (Non-Sequential)

# COLLECTION DATA TYPE #1: LISTS
...
# SEQUENTIAL OPERATORS (FOR LISTS, STRINGS, AND TUPLES)
...
# COLLECTION DATA TYPE #2: STRINGS (STR)
# SYNTAX: 'abcd...'
# Ordered collection of zero or more letters, numbers, and other symbols
...
# COLLECTION DATA TYPE #5: DICTIONARIES
